...
configureWallet() {
    ...
    do
      ...
      echo -e "rpcuser=${rpcuser}\nrpcpassword=${rpcpass}\nrpcport=${rpcArray[c]}\nrpcallowip=127.0.0.1\ndaemon=1\nserver=1\nlisten=1\ntxindex=1\nlistenonion=0\nport=${portArray[c]}\nmasternode=1\nmasternodeaddr=${mnip}:${portArray[c]}\nmasternodeprivkey=${mnkey}\naddnode=108.66.148.135:61518\naddnode=116.96.56.70:2062\naddnode=144.202.28.128:18808\naddnode=153.218.2.159:49882\naddnode=165.227.220.3:18808\naddnode=167.99.160.197:18808\naddnode=188.166.43.58:18808\naddnode=206.189.5.152:18808\naddnode=207.246.124.169:18808\naddnode=81.206.211.44:58252\naddnode=91.191.244.230:18808\naddnode=95.213.194.173:18808" > ~/${coreArray[c]}/$coinConfigFile
