...
COIN_DAEMON='/usr/local/bin/sssolutionsd'
COIN_CLI='/usr/local/bin/sssolutions-cli'
COIN_REPO='https://github.com/Simple-Software-Solutions/SSS-Core/releases/download/sssolutions_v1.1.9.2rc2/sss-1.1.9.2rc2-x86_64-linux-gnu.tar.gz'
